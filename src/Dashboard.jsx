...
const Dashboard = ({ leads, leadsFechados, usuarios }) => {
  ...
  const portoSeguro = leadsFechados.filter(lead => lead.Seguradora === 'Porto Seguro').length;
  const azulSeguros = leadsFechados.filter(lead => lead.Seguradora === 'Azul Seguros').length;
  const itauSeguros = leadsFechados.filter(lead => lead.Seguradora === 'Itau Seguros').length;
  const demais = leadsFechados.filter(lead => lead.Seguradora === 'Demais Seguradoras').length;
